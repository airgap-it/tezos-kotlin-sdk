...
public fun micheline(builderAction: MichelineMichelsonExpressionBuilder.() -> Unit = {}): MichelineNode = micheline(TezosSdk.instance.dependencyRegistry.scoped().michelsonToMichelineConverter, builderAction)
...
public fun michelineType(builderAction: MichelineMichelsonTypeExpressionBuilder.() -> Unit = {}): MichelineNode = michelineType(TezosSdk.instance.dependencyRegistry.scoped().michelsonToMichelineConverter, builderAction)
...
public fun michelineComparableType(builderAction: MichelineMichelsonComparableTypeExpressionBuilder.() -> Unit = {}): MichelineNode = michelineComparableType(TezosSdk.instance.dependencyRegistry.scoped().michelsonToMichelineConverter, builderAction)
...
public fun michelineData(builderAction: MichelineMichelsonDataExpressionBuilder.() -> Unit = {}): MichelineNode = michelineData(TezosSdk.instance.dependencyRegistry.scoped().michelsonToMichelineConverter, builderAction)
...
public fun michelineInstruction(builderAction: MichelineMichelsonInstructionExpressionBuilder.() -> Unit = {}): MichelineNode = michelineInstruction(TezosSdk.instance.dependencyRegistry.scoped().michelsonToMichelineConverter, builderAction)
