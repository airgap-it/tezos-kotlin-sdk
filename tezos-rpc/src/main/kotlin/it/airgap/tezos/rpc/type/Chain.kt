...
@Serializable
public data class RpcMainChain(@SerialName("chain_id") override val chainId: @Contextual ChainId) : RpcActiveChain()

@Serializable
public data class RpcTestChain(
...
@Serializable
public data class RpcStoppingChain(override val stopping: @Contextual ChainId) : RpcActiveChain()
