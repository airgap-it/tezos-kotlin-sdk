...
public fun OperationContent.Delegation.asRpc():RpcOperationContent.Delegation = RpcOperationContent.Delegation(source, fee.int, counter.int, gasLimit.int, storageLimit.int, delegate)
public fun OperationContent.Origination.asRpc():RpcOperationContent.Origination = RpcOperationContent.Origination(source, fee.int, counter.int, gasLimit.int, storageLimit.int, balance.int, delegate, script.asRpc())
public fun OperationContent.RegisterGlobalConstant.asRpc():RpcOperationContent.RegisterGlobalConstant = RpcOperationContent.RegisterGlobalConstant(source, fee.int, counter.int, gasLimit.int, storageLimit.int, value)
public fun OperationContent.Reveal.asRpc():RpcOperationContent.Reveal = RpcOperationContent.Reveal(source, fee.int, counter.int, gasLimit.int, storageLimit.int, publicKey)
public fun OperationContent.SetDepositsLimit.asRpc():RpcOperationContent.SetDepositsLimit = RpcOperationContent.SetDepositsLimit(source, fee.int, counter.int, gasLimit.int, storageLimit.int, limit?.int)
public fun OperationContent.Transaction.asRpc():RpcOperationContent.Transaction = RpcOperationContent.Transaction(source, fee.int, counter.int, gasLimit.int, storageLimit.int, amount.int, destination, parameters?.asRpc())
...
public fun RpcOperationContent.Delegation.asDelegation(): OperationContent.Delegation = OperationContent.Delegation(source, fee.asZarithNatural(), counter.asZarithNatural(), gasLimit.asZarithNatural(), storageLimit.asZarithNatural(), delegate)
...
public fun RpcOperationContent.Origination.asOrigination(): OperationContent.Origination = OperationContent.Origination(source, fee.asZarithNatural(), counter.asZarithNatural(), gasLimit.asZarithNatural(), storageLimit.asZarithNatural(), balance.asZarithNatural(), delegate, script.asScript())
...
public fun RpcOperationContent.RegisterGlobalConstant.asRegisterGlobalConstant(): OperationContent.RegisterGlobalConstant = OperationContent.RegisterGlobalConstant(source, fee.asZarithNatural(), counter.asZarithNatural(), gasLimit.asZarithNatural(), storageLimit.asZarithNatural(), value)
public fun RpcOperationContent.Reveal.asReveal(): OperationContent.Reveal = OperationContent.Reveal(source, fee.asZarithNatural(), counter.asZarithNatural(), gasLimit.asZarithNatural(), storageLimit.asZarithNatural(), publicKey)
...
public fun RpcOperationContent.SetDepositsLimit.asSetDepositsLimit(): OperationContent.SetDepositsLimit = OperationContent.SetDepositsLimit(source, fee.asZarithNatural(), counter.asZarithNatural(), gasLimit.asZarithNatural(), storageLimit.asZarithNatural(), limit?.asZarithNatural())
public fun RpcOperationContent.Transaction.asTransaction(): OperationContent.Transaction = OperationContent.Transaction(source, fee.asZarithNatural(), counter.asZarithNatural(), gasLimit.asZarithNatural(), storageLimit.asZarithNatural(), amount.asZarithNatural(), destination, parameters?.asParameters())
