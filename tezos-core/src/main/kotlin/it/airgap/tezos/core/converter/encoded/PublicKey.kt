...
public fun PublicKey.Companion.fromBytes(bytes: ByteArray,tezos: Tezos = Tezos.Default): PublicKey = withTezosContext {
...
public fun PublicKey.Companion.fromString(string: String, tezos: Tezos = Tezos.Default): PublicKey = withTezosContext {
