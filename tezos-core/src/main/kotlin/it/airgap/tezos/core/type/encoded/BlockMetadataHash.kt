...
@JvmInline
public value class BlockMetadataHash(override val base58: String) : Encoded<BlockMetadataHash> {

    override val kind: Encoded.Kind<BlockMetadataHash>
        get() = Companion
    ...
    public companion object : Encoded.Kind<BlockMetadataHash> {
