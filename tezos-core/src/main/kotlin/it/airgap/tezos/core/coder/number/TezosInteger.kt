...
public fun TezosInteger.encodeToBytes(tezos: Tezos = Tezos.Default): ByteArray = withTezosContext {
    encodeToBytes(tezos.coreModule.dependencyRegistry.tezosIntegerBytesCoder)
}

public fun TezosInteger.Companion.decodeFromBytes(bytes: ByteArray, tezos: Tezos = Tezos.Default): TezosInteger = withTezosContext {
    TezosInteger.decodeFromBytes(bytes, tezos.coreModule.dependencyRegistry.tezosIntegerBytesCoder)
}

@InternalTezosSdkApi
public interface TezosIntegerCoderContext {
