...
import it.airgap.tezos.core.internal.coder.MutezBytesCoder
...
@InternalTezosSdkApi
public fun Mutez.encodeToBytes(mutezBytesCoder: MutezBytesCoder): ByteArray =
    mutezBytesCoder.encode(this)

@InternalTezosSdkApi
public fun Mutez.Companion.decodeFromBytes(bytes: ByteArray, mutezBytesCoder: MutezBytesCoder): Mutez =
    mutezBytesCoder.decode(bytes)

@InternalTezosSdkApi
public fun Mutez.Companion.decodeConsumingFromBytes(bytes: MutableList<Byte>, mutezBytesCoder: MutezBytesCoder): Mutez =
