...
@InternalTezosSdkApi
public class BytesToPublicKeyEncodedConverter(base58Check: Base58Check) : BytesToEncodedGroupedConverter<PublicKeyEncoded<*>>(base58Check) {
    override val kinds: List<Encoded.Kind<out PublicKeyEncoded<*>>>
