...
public fun Secp256K1Signature.encodeToBytes(tezos: Tezos = Tezos.Default): ByteArray =
    encodeToBytes(tezos.dependencyRegistry.core().encodedBytesCoder)

public fun Secp256K1Signature.Companion.decodeFromBytes(bytes: ByteArray, tezos: Tezos = Tezos.Default): Secp256K1Signature =
    Secp256K1Signature.decodeFromBytes(bytes, tezos.dependencyRegistry.core().encodedBytesCoder)
