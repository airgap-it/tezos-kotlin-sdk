...
/**
 * Encodes a [Secp256K1Signature] to [ByteArray].
 * Takes an optional [tezos] object to provide context. If the argument was omitted, the default [Tezos] instance will be used.
 *
 * See `samples/src/test/kotlin/type/Signature/Secp256K1SignatureSamples.Coding#toBytes` for a sample usage.
 */
...
/**
 * Decodes a [Secp256K1Signature] from [ByteArray].
 * Takes an optional [tezos] object to provide context. If the argument was omitted, the default [Tezos] instance will be used.
 *
 * See `samples/src/test/kotlin/type/Signature/Secp256K1SignatureSamples.Coding#fromBytes` for a sample usage.
 */
