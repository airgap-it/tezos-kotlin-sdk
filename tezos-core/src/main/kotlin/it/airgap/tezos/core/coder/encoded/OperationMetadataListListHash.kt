...
public fun OperationMetadataListListHash.encodeToBytes(tezos: Tezos = Tezos.Default): ByteArray =
    encodeToBytes(tezos.dependencyRegistry.core().encodedBytesCoder)

public fun OperationMetadataListListHash.Companion.decodeFromBytes(bytes: ByteArray, tezos: Tezos = Tezos.Default): OperationMetadataListListHash =
    OperationMetadataListListHash.decodeFromBytes(bytes, tezos.dependencyRegistry.core().encodedBytesCoder)
