...
: Address = bytesToAddressConverter.convert(bytes).toEncoded()
...
): Address = stringToAddressConverter.convert(string).toEncoded()
...
): ImplicitAddress = bytesToImplicitAddressConverter.convert(bytes).toEncoded()
...
): ImplicitAddress = stringToImplicitAddressConverter.convert(string).toEncoded()
...
): PublicKeyEncoded = bytesToPublicKeyConverter.convert(bytes).toEncoded()
...
): PublicKeyEncoded = stringToPublicKeyConverter.convert(string).toEncoded()
...
): SignatureEncoded = bytesToSignatureConverter.convert(bytes).toEncoded()
...
): SignatureEncoded = stringToSignatureConverter.convert(string).toEncoded()
...
): GenericSignature = signatureToGenericSignatureConverter.convert(toMetaEncoded())
