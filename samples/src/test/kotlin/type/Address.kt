...
class AddressSamples {
    ...
    class Coding {
        ...
        fun toBytes() {
            ...
            assertContentEquals(hexToBytes("0000d7a60d4e90e8a33ec835159191b14ce4452f12f8"), tz1Address.encodeToBytes(tezos))

            val tz2Address: Address = Secp256K1PublicKeyHash("tz2AjVPbMHdDF1XwHVhUrTg6ZvqY83AYhJEy")
            assertContentEquals(hexToBytes("00011a868789216112194b3bb003e8384c8f7217b288"), tz2Address.encodeToBytes())
            assertContentEquals(hexToBytes("00011a868789216112194b3bb003e8384c8f7217b288"), tz2Address.encodeToBytes(tezos))

            val tz3Address: Address = P256PublicKeyHash("tz3Nk25g51knuzFZZz2DeA5PveaQYmCtV68B")
            assertContentEquals(hexToBytes("00021a78f4332a6fe15b979904c6c2e5f9521e1ffc4a"), tz3Address.encodeToBytes())
            assertContentEquals(hexToBytes("00021a78f4332a6fe15b979904c6c2e5f9521e1ffc4a"), tz3Address.encodeToBytes(tezos))
            ...
            assertContentEquals(hexToBytes("016077cd98fd8aca94851b83a4c44203b705d2004b"), kt1Address.encodeToBytes(tezos))
        }
        ...
        fun fromBytes() {
            ...
            assertEquals(Ed25519PublicKeyHash("tz1fJGtrdmckD3VkiDxqUEci5h4gGcvocw6e"), Address.decodeFromBytes(tz1Address, tezos))
            ...
            assertEquals(Secp256K1PublicKeyHash("tz2AjVPbMHdDF1XwHVhUrTg6ZvqY83AYhJEy"), Address.decodeFromBytes(tz2Address, tezos))
            ...
            assertEquals(P256PublicKeyHash("tz3Nk25g51knuzFZZz2DeA5PveaQYmCtV68B"), Address.decodeFromBytes(tz3Address, tezos))
            ...
            assertEquals(ContractHash("KT1HNqxFJxnmUcX8wF915wxxaAAU4ixDwWQ7"), Address.decodeFromBytes(kt1Address, tezos))
        }
    }
}
...
class ImplicitAddressSamples {
    ...
    class Coding {
        ...
        fun toBytes() {
            ...
            val tz1Address: ImplicitAddress = Ed25519PublicKeyHash("tz1fJGtrdmckD3VkiDxqUEci5h4gGcvocw6e")
            assertContentEquals(hexToBytes("00d7a60d4e90e8a33ec835159191b14ce4452f12f8"), tz1Address.encodeToBytes())
            assertContentEquals(hexToBytes("00d7a60d4e90e8a33ec835159191b14ce4452f12f8"), tz1Address.encodeToBytes(tezos))

            val tz2Address: ImplicitAddress = Secp256K1PublicKeyHash("tz2AjVPbMHdDF1XwHVhUrTg6ZvqY83AYhJEy")
            assertContentEquals(hexToBytes("011a868789216112194b3bb003e8384c8f7217b288"), tz2Address.encodeToBytes())
            assertContentEquals(hexToBytes("011a868789216112194b3bb003e8384c8f7217b288"), tz2Address.encodeToBytes(tezos))

            val tz3Address: ImplicitAddress = P256PublicKeyHash("tz3Nk25g51knuzFZZz2DeA5PveaQYmCtV68B")
            assertContentEquals(hexToBytes("021a78f4332a6fe15b979904c6c2e5f9521e1ffc4a"), tz3Address.encodeToBytes())
            assertContentEquals(hexToBytes("021a78f4332a6fe15b979904c6c2e5f9521e1ffc4a"), tz3Address.encodeToBytes(tezos))
        }
        ...
        fun fromBytes() {
            ...
            assertEquals(Ed25519PublicKeyHash("tz1fJGtrdmckD3VkiDxqUEci5h4gGcvocw6e"), ImplicitAddress.decodeFromBytes(tz1Address, tezos))
            ...
            assertEquals(Secp256K1PublicKeyHash("tz2AjVPbMHdDF1XwHVhUrTg6ZvqY83AYhJEy"), ImplicitAddress.decodeFromBytes(tz2Address, tezos))
            ...
            assertEquals(P256PublicKeyHash("tz3Nk25g51knuzFZZz2DeA5PveaQYmCtV68B"), ImplicitAddress.decodeFromBytes(tz3Address, tezos))
        }
    }
}